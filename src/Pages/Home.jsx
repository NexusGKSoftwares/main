...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/NexusGKSoftwares" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/nexusgk/" },
  { icon: Instagram, link: "https://www.instagram.com/nexus_gk" }
];
